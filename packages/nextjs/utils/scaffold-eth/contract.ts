...
// Debug log to show deployed contracts by chain
console.log("Available contract chains:", Object.keys(deployedContractsData));
console.log("Default chain:", scaffoldConfig.targetNetworks[0].name);
// Log Corn Testnet contracts if available
if (deployedContractsData[21000001]) {
  console.log("Corn Testnet contracts:", Object.keys(deployedContractsData[21000001]));
}
