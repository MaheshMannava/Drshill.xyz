...
export const MemeCard: React.FC<MemeCardProps> = ({
  ...
  return (
    <>
      <div
        className={`p-4 bg-white dark:bg-base-100 mb-1 border-b border-gray-200 dark:border-gray-700 cursor-pointer ${className}`}
      ...
      >
        <div className="flex gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-lg font-bold text-black dark:text-white">${symbol}</h2>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-1">
                ...
                <button
                  className="bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 p-1.5 rounded-none flex items-center justify-center w-8 h-8"
                  onClick={e => {
                    e.stopPropagation();
                    console.log("Ticket", symbol);
                  }}
                >
                  <Ticket className="h-4 w-4 text-gray-800 dark:text-gray-200" />
                </button>
                <button
              ...
              <div className="flex items-center">
                ...
                <span className="font-mono font-bold text-black dark:text-white">{ticketCount}</span>
              </div>
            </div>
          </div>
        </div>
